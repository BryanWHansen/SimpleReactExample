...
function App() {
  ...
  const handleButtonClick = () => {
    setSummaryState(
      summaryState.maxChar > 0
        ? { maxChar: -1, buttonText: "Less" }
        : { maxChar: 100, buttonText: "More" }
    );
  };
  ...
  return (
    <div>
      ...
      <Divider component="div" style={{ margin: "5px 0px" }} />
      <div>
        <h3>STATE HOOK FORM</h3>
      </div>
      <StateForm />
      <Divider component="div" style={{ margin: "5px 0px" }} />
      <Summary
        maxChars={summaryState.maxChar}
        buttonText={summaryState.buttonText}
